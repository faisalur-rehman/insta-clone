...
class _PostState extends State<Post> {
  ...
  final String caption =
      '''Styling text in Flutter. #Another, #nepal, Styling text in Flutter. #ktm, #love, #newExperiance.''';
  ...
  Widget userInfoRow() => Row(
        children: <Widget>[
          CircleImage(
            widget.galleryItems["ProfilePic"],
            imageSize: 36.0,
            whiteMargin: 2.0,
            imageMargin: 6.0,
          ),
          Text(widget.galleryItems["Name"]),
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: '${widget.galleryItems["Likes"]} others ',
                    style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.bold),
                  ),
                ],
  ...
  Widget comments() => Padding(
        ...
        child: Text(
          'View all ${widget.galleryItems["Comments"]} comments',
